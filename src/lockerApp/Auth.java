...
import usersHub.UserCredentials;
import usersHub.Users;

public class Auth {
	
	
	private static Scanner inptext;
	...
	public static void registerUser() {
		...
		String username = inptext.next();
		users.setUsername(username);
		
		System.out.println("Enter Password :");
		String password = inptext.next();
	...
	public static void loginUser() {
		...
		System.out.println("==========================================");
		System.out.println("Enter Username :");
		String inpUsername = inptext.next();
		boolean found = false;
		while(input.hasNext() && !found) {
			if(input.next().equals(inpUsername)) {
				System.out.println("Enter Password :");
				String inpPassword = inptext.next();
	...
	public static void initApp() {
		...
		File  lockerFile = new File("credsstorage.txt");
